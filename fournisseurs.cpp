...
bool fournisseurs::ajouter()
{
    ...
    query.prepare("INSERT INTO fournisseurs (ID_FOURNISEUR,NOM,PRENOM,ADRESSE,EMAIL,NUM_TEL)"
                          "VALUES (:id, :nom, :prenom, :email, :adresse, :num_tel)");  //thez mel classe li fel QT lel BD
